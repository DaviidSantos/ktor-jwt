...
import com.bambilabs.routing.request.UserRequest
import com.bambilabs.routing.response.UserResponse
...
fun Route.userRoute(
    ...
    authenticate("another-auth") {
        get("/{id}") {
            ...
            val foundUser = userService.findById(UUID.fromString(id))
